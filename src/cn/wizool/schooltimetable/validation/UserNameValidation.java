...
/**
 * Servlet implementation class UserNameValidation
 */
@WebServlet(description = "用户名验证", urlPatterns = { "/UserNameValidation" })
public class UserNameValidation extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Logger logger=Logger.getLogger(UserNameValidation.class);
