var App = function () {
  ...
  var dashboard = function(){
    ...
    $(".chat-in form").submit(function(e){
      ...
      var msg = inp.val();
      var img = 'avatar1_50-1.jpg'/*tpa=http://www.jq22.com/demo/cleanzone201706270112/js/behaviour/images/avatar1_50.jpg*/;
  ...
  var masks = function(){
    ...
    $("[data-mask='currency']").mask("http://www.jq22.com/demo/cleanzone201706270112/js/behaviour/$999,999,999.99");
  };//End of masks
  ...
  return {
    ...
    init: function (options) {
      ...
      if(config.hiddenElements){
        ...
        $('.nav-tabs').on('http://www.jq22.com/demo/cleanzone201706270112/js/behaviour/shown.bs.tab', function (e) {
          $(".nscroller").nanoScroller();
        });
      }
