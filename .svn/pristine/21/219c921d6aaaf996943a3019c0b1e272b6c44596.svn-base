...
/**
 * Servlet implementation class TeacherRulesUpload
 */
@WebServlet(description = "规则结果上传", urlPatterns = { "/TeacherRulesUpload" })
public class TeacherRulesUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private static Logger logger=Logger.getLogger(TeacherRulesUpload.class);
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TeacherRulesUpload() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String sql1="DELETE \r\n" + 
					...
					"	xiaoxuan.`时间教师设置`\r\n" + 
					"WHERE\r\n" + 
					"	xiaoxuan.`时间教师设置`.taskid = '"+common.getTaskid()+"'\r\n" + 
			...
			for (JieciCommon jieciCommon :common.getbanlist()) {
				String sql="INSERT INTO `xiaoxuan`.`时间教师设置` (\r\n" + 
						"	`taskid`,\r\n" + 
						"	`schoolid`,\r\n" + 
						"   `jieciid`,\r\n" +
						"	`teachername`,\r\n" + 
						...
						"		'"+common.getSchoolid()+"',\r\n" + 
						"		'"+jieciCommon.getId()+"',\r\n" + 
						"		'"+jieciCommon.getTeachername()+"',\r\n" + 
						"		'"+jieciCommon.getTeacherid()+"',\r\n" + 
